...
class ManageCompanyVisits extends ManageRelatedRecords
{
    ...
    protected static ?string $title = 'Company visits';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('service.name')->label('Service')->searchable()->placeholder('—')->wrap(),
                Tables\Columns\TextColumn::make('client_name')->label('Client')->searchable()->placeholder('—')->wrap(),
                ...
                Tables\Columns\TextColumn::make('starts_at')->label('Starts at')->dateTime()->sortable(),
            ])
            ->filters([
